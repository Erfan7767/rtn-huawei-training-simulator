...
export default function Rtn950NeAttributeLab() {
  ...
  return <main className="neattr-page" dir="ltr">
    ...
    <header className="neattr-header"><a href="/rtn950a-link-lab"><ChevronLeft size={15}/> Microwave Link Configuration</a><div><span>✺</span><b>Web LCT</b><em>NE Attribute Training Lab</em></div><button onClick={reset} aria-label="Reset NE Attribute training draft"><RotateCcw size={15}/></button></header>
    ...
    <section className="neattr-shell">
      ...
      <section className="neattr-main" data-testid="ne-attribute-lab" data-active-step={step}>
        <div className="neattr-tabs"><a href="/rtn950a-slot-layout">Slot Layout</a><a href="/rtn950a-link-lab">Microwave Link Configuration</a><button className="active">NE Attribute <X size={12}/></button></div>
        <div className="neattr-heading"><div><p>CONFIGURATION / NE ATTRIBUTE</p><h1>NE Attribute: change-and-relogin training</h1><span>وحدة تدريبية مستقلة لتعلم أثر تغيير الهوية على جلسة الإدارة، من دون عناوين أو هويات ميدانية.</span></div><div className="neattr-badge"><Radio size={17}/><b>RTN950 1+0 reference</b><small>Separate source scope</small></div></div>
