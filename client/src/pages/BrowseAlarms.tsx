  ...
  return (
    <main className="alarms-page" aria-label="Browse Current Alarms training replica">
      ...
      <header className="alarms-topbar">
        <div className="alarms-brand"><div className="alarms-sun">✺</div><b>Web LCT</b><span>Browse Current Alarms reference screen</span></div>
      ...
      <div className="alarms-context"><span>NE NAME: TRAINING-ALARM-NE</span><span>REFERENCE NE VERSION: 212.19.21</span><span>CURRENT USER: TRAINING</span><span>NE STATE: RUNNING — SIMULATED</span><div className="alarm-counts"><i className="red">—</i><i className="amber">—</i><i className="yellow">—</i><i className="blue">—</i></div></div>
